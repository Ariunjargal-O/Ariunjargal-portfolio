...
import { socialLinks } from "../../config/portfolio-config";
  ...
  return (
    ...
    >
      <div className="container w-full px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            ...
            >
              ...
              <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 h-12 sm:h-14 lg:h-16 mb-4">
                <TypeAnimation
                  key={locale} // ← ЭНЭ НЭМЭХ — locale солигдоход дахин эхлэнэ
                  sequence={t.hero.typeSequence.flatMap((text) => [text, 1000])}
                  wrapper="span"
                  speed={50}
                  repeat={Number.POSITIVE_INFINITY}
                />
        ...
        >
          <span className="text-xs sm:text-sm text-gray-200 mb-1 sm:mb-2 drop-shadow-lg">
            {t.hero.scrollDown}
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
