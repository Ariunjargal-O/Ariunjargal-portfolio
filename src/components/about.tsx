...
export default function About() {
  ...
  const stats = [
    { value: "9+", label: t.stats.yearsInJapan },
                ...
                >
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-base sm:text-lg font-bold text-white">
                          {t.about.education.cert}
                        </h4>
                        <p className="text-muted-foreground text-sm sm:text-base">
                          {t.about.education.academy}
                        </p>
                        <p className="text-xs sm:text-sm text-muted-foreground">
                          {t.about.education.certYear}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 py-4 sm:py-5 text-gray-400 text-sm sm:text-base">
                <div>
                  <p className="font-medium text-gray-200 mb-1">
                    {t.about.infoLabels.name}
                  </p>
                  <p className="break-words">{personalInfo.name}</p>
                </div>
                <div>
                  <p className="font-medium text-gray-200 mb-1">
                    {t.about.infoLabels.email}
                  </p>
                  <p className="break-all">{personalInfo.email}</p>
                </div>
                <div>
                  <p className="font-medium text-gray-200 mb-1">
                    {t.about.infoLabels.location}
                  </p>
                  <p>{t.personalInfo.location}</p>
                </div>
                <div>
                  <p className="font-medium text-gray-200 mb-1">
                    {t.about.infoLabels.availability}
                  </p>
                  <p>{t.personalInfo.availability}</p>
                </div>
              </div>
